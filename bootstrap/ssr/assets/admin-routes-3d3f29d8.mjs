...
function useDatatableData(endpoint2, params, options, onLoad) {
  return useQuery({
    ...
    queryFn: () => paginate(endpoint2, params, onLoad),
    placeholderData: keepPreviousData,
    ...options
  });
}
async function paginate(endpoint2, params, onLoad) {
  const response = await apiClient.get(endpoint2, { params }).then((response2) => response2.data);
...
const IconList = React.lazy(() => import("./icon-list-a83a422c.mjs"));
...
const AceEditor = React.lazy(() => import("./ace-editor-12938051.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-87839830.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-97648825.mjs"));
...
//# sourceMappingURL=admin-routes-3d3f29d8.mjs.map
