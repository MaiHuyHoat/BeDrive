...
function TimezoneSelect({ name, size: size2, timezones, label }) {
  const { trans } = useTrans();
  return /* @__PURE__ */ jsx(
    FormSelect,
    {
...
const BillingPageRoutes = React.lazy(
  () => import("./assets/billing-page-routes-51e3b142.mjs")
);
const CheckoutRoutes = React.lazy(() => import("./assets/checkout-routes-a7c7e9c7.mjs"));
...
const AdminRoutes = React.lazy(() => import("./assets/admin-routes-3d3f29d8.mjs").then((n) => n.z));
const DriveRoutes = React.lazy(() => import("./assets/drive-routes-9c353773.mjs"));
...
export {
  ...
  NotificationsIcon as bA,
  PaymentsIcon as bB,
  PeopleIcon as bC,
  PersonIcon as bD,
  PhonelinkLockIcon as bE,
  SmartphoneIcon as bF,
  TabletIcon as bG,
  useCollator as bH,
  elementToTree as bI,
  EnvatoIcon as bJ,
  ...
  DarkModeIcon as bo,
  DevicesIcon as bp,
  ErrorOutlineIcon as bq,
  FileDownloadDoneIcon as br,
  ForumIcon as bs,
  GroupAddIcon as bt,
  LanguageIcon as bu,
  LightModeIcon as bv,
